public class Main{
    public static void main(String[] args) {
        ...
        Materia matematicas = new Materia("Matemáticas", 67890, new int[]{1, 3, 7});
        Materia historia = new Materia("Historia", 11223, new int[]{5, 6, 7});
        Materia fisica = new Materia("Física", 33445, new int[]{9, 8, 10});
        Materia quimica = new Materia("Química", 55667, new int[]{7, 8, 6});
        Materia literatura = new Materia("Literatura", 77889, new int[]{3, 3, 3});
        Materia biologia = new Materia("Biología", 99001, new int[]{6, 7, 8});
        Materia filosofia = new Materia("Filosofía", 22334, new int[]{7, 6, 10});
        Materia educacionFisica = new Materia("Educación Física", 44556, new int[]{9, 8, 10});
        Materia arte = new Materia("Arte", 66778, new int[]{8, 7, 9});
        Materia musica = new Materia("Música", 88990, new int[]{10, 10, 9});
        Materia tecnologia = new Materia("Tecnología", 10112, new int[]{7, 8, 9});
        Materia filosofiaModerna = new Materia("Filosofía Moderna", 12134, new int[]{8, 9, 7});
        ...
        // Crear algunos talleres
        Taller programacion = new Taller("Taller de Programación", 10);
        Taller diseno = new Taller("Taller de Diseño", 8);
        Taller fotografia = new Taller("Taller de Fotografía", 12);
        Taller escrituraCreativa = new Taller("Taller de Escritura Creativa", 12);
        Taller cocina = new Taller("Taller de Cocina", 13);
        Taller musica = new Taller("Taller de Música", 12);
        Taller arte = new Taller("Taller de Arte", 13);
        Taller deporte = new Taller("Taller de Deporte", 11);
        Taller marketingDigital = new Taller("Taller de Marketing Digital", 9);
        Taller liderazgo = new Taller("Taller de Liderazgo", 6);
        Taller fotografiaAvanzada = new Taller("Taller de Fotografía Avanzada", 8);
        Taller programacionAvanzada = new Taller("Taller de Programación Avanzada", 15);
        Taller disenoGrafico = new Taller("Taller de Diseño Gráfico", 13);
        Taller gestionDeProyectos = new Taller("Taller de Gestión de Proyectos", 10);
        Taller comunicacionEfectiva = new Taller("Taller de Comunicación Efectiva", 12);
